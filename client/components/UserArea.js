            ...
            <Grid container spacing={2}>
                <Grid item>
                    <ButtonBase>
                        ...
                        <Img alt="complex" src="https://i.pravatar.cc/300" sx={{ width: '3.55rem', height: '4rem', borderRadius: 1}}/>
                    </ButtonBase>
                </Grid>
                <Grid item xs={12} xs container>
                    <Grid item xs container direction="column" spacing={2}>
                        ...
                        <Grid item style={{ paddingTop: 0,}}>
                            <Button variant="contained" size="small" style={{ backgroundColor: '#4B115C', width: '4rem', height: '1.5rem', padding: 0}}>
                                English
                            </Button>
                            <IconButton color="primary" aria-label="upload picture" component="label">
                                <AddButton style={{backgroundColor: '#4B115C', color: 'white', width: '1.5rem', height:'1.5rem', borderRadius: '0.3rem'}} />
                            </IconButton>
                        </Grid>
                    </Grid>
                    <Grid item>
